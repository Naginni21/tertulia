...
STRINGS: dict[str, dict[str, str]] = {
    "es": {
        ...
        "unknown_ritual": "No conozco ese ritual. Disponibles: {rituals}.",
        "status_next": "Próximo ritual: {ritual}, {when}.",
        "when": "el {weekday} a las {time}",
        "weekday_0": "lunes", "weekday_1": "martes", "weekday_2": "miércoles", "weekday_3": "jueves",
    ...
    "en": {
        ...
        "unknown_ritual": "Unknown ritual. Available: {rituals}.",
        "status_next": "Next ritual: {ritual}, {when}.",
        "when": "{weekday} at {time}",
